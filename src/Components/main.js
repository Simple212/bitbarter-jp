    ...
    return(
        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >作業</span></Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://hi.bitbarter.org" target="_blank" >हिंदी    <img src={require(`./india.jpg`)} className='flag1' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://jp.bitbarter.org" target="_blank">日本語 <img src={require(`./japan.png`)} className='flag2' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://cn.bitbarter.org" target="_blank">中文 <img src={require(`./china.png`)} className='flag3' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://ru.bitbarter.org" target="_blank">руский <img src={require(`./russia.png`)} className='flag4' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://bitbarter.org" target="_blank">English <img className='flag5' src={require(`./en.png`)} width='30px' /> </Dropdown.Item>
                            </Dropdown.Menu>
            ...
            <Row className='tc text-center justify-content-center align-items-center'>
                ...
                <Button className={'btn1 b shadow-3'} style={{'background-color':`${value100912}`, 'color':`${value10059}`, 'border':`${value10057}`} } >変動レート</Button>
                </Col>
                
                <Col className='col-md-4 text-black'>
                <Button className={'btn1 b shadow-3'} style={{'background-color':`${value100912}`, 'color':`${value10059}`, 'border':`${value10057}`} } >固定レート</Button>
                </Col>
            </Row>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				...
				setLgShow2('SEND')
                    ...
                    <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >あなたが送る</h3>
                ...
                <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >あなたが受け取る</h3>
            ...
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p className='b para258' style={{'color':`${value10059}`}}>送信する金額を入力します</p>
            ...
            <p className='b text-red text-center tc para3000' style={{'display':`${value501}`}} >最小 金额 {value3} {lgShow233} 为</p>
            <p className='b text-red text-center tc para3000' style={{'display':`${value1600}`}} >金額を入力してください</p>
            </Col>
            </Row>
            
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p style={{'color':`${value10059}`}} className='b para10'>受信アドレス</p>
                </Col>
            </Row>
            ...
            <Row className='mt-0'>
            <Col className='col-md-12 text-black'>
            <input id="name" className="input_address b  text-center tc input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="name-desc" placeholder={`${value4} アドレス`} onChange={event1} onFocus={value1006} />
            <p className='b text-red text-center tc para3000' style={{'display':`${value500}`}} >कृपया एक मान्य {value4} पता दर्ज करें</p>
            <p className='b text-red text-center tc para3000' style={{'display':`${value1500}`}} >住所を入力してください</p>
                </Col>
            </Row>

            <Row className='mt-3'>
                <Col className='col-md-12 text-black'>
                <Button className='btn2 b shadow-3' style={{'background-color':`${value100910}`,'border':`${value10057}`,'color':`${value10059}`}}  onClick={call}>交換</Button>
                </Col>
            </Row>
      ...
      <h3 className='b tc'>あなたが {lgShow2} </h3>
      </Col>
      </Row>
      </Modal.Title>
      </Modal.Header>
      ...
      <h3 className='b tc text-black'>YOU {lgShow2} </h3>
        ...
        <Modal.Body >
            ...
            <h2 className='tc b mt-4 text-center'>クリプトを交換する方法</h2>
            <p className='tc text-cente br'>Bitbarterでは、暗号の交換はシンプルで簡単です。。</p>
            <p className='tc text-center'>4つのステップに従ってください</p>
            ...
            <h6>Exchangeをクリックします</h6>
            </Col>
            <Col className='col-md-3 mt-4 mb-4'>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="mt-3 mb-3 bi bi-currency-yen" viewBox="0 0 16 16">
