        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >作業</span></Nav.Link>
                            ...
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br1 btn_login b shadow-4' onClick={changetologin}>ログイン</Button>
                            </Nav.Link>
                            
                            <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink'>
                            <Button className='br1 btn-danger b shadow-4' onClick={changetosignup} >サインアップ</Button>
                            </Nav.Link>
