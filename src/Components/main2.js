...
const Main2 =({value10,value5,value11,value6,value3,value1005,value1009,final56,backtohome2,amount23,final90,orderid})=>{
    ...
    return(
        <div>
                        ...
                        <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink b text-black'>財布<img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Icon_green_lamp_on.svg/512px-Icon_green_lamp_on.svg.png'  className='ms-2' width={'15px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center">作業</span>
                        </Nav.Link>
                        <Nav.Link href="#home" className='d-flex justify-content-center align-items-center navlink b text-black'>システムステータス<img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Icon_green_lamp_on.svg/512px-Icon_green_lamp_on.svg.png' className='ms-2' width={'15px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center">作業</span></Nav.Link>
                        </Nav>
                        </Navbar.Collapse>
                    </Container>
                </Navbar>
        ...
        <h2 className='b text-black text-center'>注文番号</h2>
        <h5 className="b text-black text-center">{orderid}</h5>
            ...
            <Row className='d-flex justify-content-center align-items-center mt-4'>
                ...
                <h3 className='b text-black text-center h3_send'><span style={{'color':`${lgShow566}`}}>{amount23}</span> {value3} を送ってください </h3>
                <p className="b text-black text-center fs-5">下記アドレスまで…………</p>
                </Col>xz
            ...
            <Row className='d-flex justify-content-center align-items-center'>
                <Col className='col-md-12'>
                <p className='b text-black text-center mt-2 mb-2 fs-5'>支払いを待っている....</p>
            ...
            <Row className='d-flex justify-content-center align-items-center' onLoad={final90}>
                <Col className='col-md-12'>
                <h3 className='b text-black text-center h3_rec'>受信アドレス...</h3>
